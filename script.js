...
function takeCommand(message) {
    ...
    if (message.includes("hello") || message.includes("hey")) {
        ...
        speak("i am virtual assistant, created by ubada alvi");
        ...
        let finalText = "this is what i found on internet regarding" + message.replace("alexa", "") || message.replace("shifra", "")
        speak(finalText)
